...
<style>
	...
	.page_title .sub_txt { width: 100%;margin: 70px auto;text-align: justify }
...
<!--===========================================================================================================================-->
        ...
        <article><!--+++++ 컨텐츠 04 시작 +++++-->
           <div class="tab_menu tab02"><!-- 4depth -->
                <ul>
                    <!-- 처음 활성화 메뉴에 class="on" -->
                    <li class="on"><a href="/theme/gicert/manage/01_quality_ISO9001.php#con4-1" data-slide-index="0">ISO 13485</a></li>
                    <li><a href="/theme/gicert/manage/01_quality_ISO9001.php#con4-2" data-slide-index="1">ISO 15378</a></li>
                    <li><a href="/theme/gicert/manage/01_quality_ISO9001.php#con4-3" data-slide-index="2">ISO 14155</a></li>
                </ul>
            </div>
            <div class="tab_con2">
                <div class="slider">
                <section style="display:block;" id="con4-1" class="roll roll01"><!-- 4depth 컨텐츠 04-1 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
                ...
                <section style="display:block;" id="con4-2"  class="roll roll02"><!-- 4depth 컨텐츠 04-2 -->
                    <div class="page_title">
                ...
                <section style="display:block" id="con4-3"  class="roll roll03"><!--4depth 컨텐츠 04-3 -->
                    <div class="page_title">
...
<!--============================================================================================================================-->
        ...
        <article><!--+++++ 컨텐츠 05 시작 +++++-->
           <div class="tab_menu tab02"><!-- 4depth -->
            ...
            <div class="tab_con2">
                <section style="display:block;"><!-- 4depth 컨텐츠 05-1 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
                        <h1 class="sub_tit">ISO 22000</h1>
...
<!--==============================================================================================================================================================-->
           ...
           <div class="tab_menu tab02"><!-- 4depth -->
                <ul>
                    ...
                    <li><a href="javascript:;">ISO/IEC 20001-1</a></li>
                </ul>
            </div>
            <div class="tab_con2">
                <section style="display:block;"><!-- 4depth 컨텐츠 07-1 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
        ...
        <article><!--+++++ 컨텐츠 08 시작 +++++-->
           <div class="tab_menu tab02"><!-- 4depth -->
                <ul>
                    ...
                    <li><a href="javascript:;">ISO 37301</a></li>
                </ul>
            </div>
            <div class="tab_con2">
                <section style="display:block"><!-- 4depth 컨텐츠 08-1 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
                ...
                <section><!-- 4depth 컨텐츠 08-2 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
...
<!--===============================================================================================  -->
        ...
        <article><!--+++++ 컨텐츠 13 시작 +++++-->
           <div class="tab_menu tab02"><!-- 4depth -->
            ...
            <div class="tab_con2">
                <section style="display:block"><!-- 4depth 컨텐츠 13-1 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
                ...
                <section><!-- 4depth 컨텐츠 13-2 (처음 활성화 컨텐츠에만 style="display:block") -->
                    <div class="page_title">
