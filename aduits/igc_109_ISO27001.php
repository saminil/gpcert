...
<div class="content_wrap">
  ...
  <div class="tab_con"><!--+++ 20.05.15 탭컨텐츠 영역 시작 +++-->
   ...
   <!--+++++ 컨텐츠 01 ISO 20000-1 (처음 활성화 컨텐츠에만 style="display:block") +++++-->
	...
	<article style="display:block;"><!--+++++ 컨텐츠 02 (처음 활성화 컨텐츠에만 style="display:block") +++++-->
	<section class="page_title">
   ...
   <article><!-------+++++++ / article  컨텐츠 03 심사원인증 >  ISO 22716 심사원 인증  시작  /++++++++++--------------->   
	...
	<section class="vision_type5">
		...
		<div class="vision_area">
		     <h2>
               <span style="display:block;font-size:1.3em;text-align:left;margin-bottom:-25px;color:#009999;"> 
                <span style="font-size:0.5em;color:#3366ff;">&#9632; </span>
                ISO 22716 심사원 인증 절차
               </span> <br>
            </h2>
		<ul>
   ...
   <article><!-------+++++++ / article  컨텐츠 04 심사원인증 >  ISO 50001 심사원 인증  시작  /++++++++++--------------->   
       <section class="page_title">
