	       	...
	       	<div class="business_info">
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				...
	       				<ul>
	       					...
	       					<li style="margin:0 auto;text-align:justify;">의료기기 지침서(93/42/EC)의 부속서 IX는 의료기기를 분류할 수 있는 18개의 규칙을 제공합니다. 이 규칙들에 따라 의료기기는 의료기기의 의도된 목적에 따라 분류됩니다.</li>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				...
	       				<ul>
	       					<li>유럽의 의료기기 지침인 MDD (93/42/EC)는 2020년 5월 26일부터 MDR로 완전히 대체됩니다. 이후에는 MDD로의 CE인증 신청이 불가능하며, 새로운 의료기기는 MDR (2017/745/EU) 요구사항을 충족시켜야만 합니다.</li>
	        			...
	        			<div class="txt_area">
	        				...
	        				<ul>
                                <span style="display:block;margin-left:5px;text-align:justify;">
                                 ...
                                 <li> 법규내용 : Council Directive 93/42/EC (MDD) + Council Directive 90/385/EC (AIMD)</li>
		...
		<div class="business_info">
			...
			<div class="backImg">
				<div class="txt_area">
					...
					<ul>
					    <span style="display:block;text-align:left;font-weight:bold;">&#10048; CE Machinery Directive(2006/42/EC)의 구성</span><br>
						<li style="margin:0 auto;text-align:justify;">
					...
					<img src="images/product_cemachinery_08.jpg" alt="CE Machinery Directive(2006/42/EC) 핵심 요구사항">
					</h1>
                    <br>
...
<article><!--+++++ /컨텐츠 09번째, Hot-water boiler, 컨텐츠 시작 +++++-->
    <div class="page_title">
		...
		<h2 class="sub_txt">
            <span style="margin:0 auto;display:inline-block;text-align:justify;">
            92/42/EC는 정격 출력이 4 kW 이상 400 kW 이하인 액체 또는 기체 연료로 연소되는 새로운 온수 보일러의 효율성 요건에 대한 지침으로, 유럽 연합의 에너지 효율 촉진에 관한 SAVE 프로그램의 일부에 의거합니다.<br><br>
...
</article><!--+++++ /컨텐츠 08번째, Hot-water boiler, 컨텐츠 종료 +++++-->


<article><!--+++++ /컨텐츠 09번째 Gas Applicance 컨텐츠 시작 +++++-->
    <div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">Gas Appliance | 가스 연료 연소기기 </span> / 유럽 제품인증 소개</h1>
		<h2 class="sub_txt">
  ...
  </article><!--+++++ /컨텐츠 09번째 Gas Applicance 컨텐츠 종료 +++++-->     
