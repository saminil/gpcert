...
<style>
    ...
    .business_type13 .business_info .backImg:nth-child(2n){margin:0 auto;} /* 짝수 번째 이미지 위치  */
	.business_type13 .business_info .backImg:nth-child(1){background:url('images/map_core_2_5_1.jpg') no-repeat center top; }
	.business_type13 .business_info .backImg:nth-child(2){background:url('images/e-belgesi-e-isareti.jpg') no-repeat center top; }
	.business_type13 .business_info .backImg:nth-child(3){background:url('images/E-Mark_mercedes.jpg') no-repeat center top; }
    .business_type13 .business_info .backImg:nth-child(4){background:url('images/E-Mark_mercedes2.jpg') no-repeat center top; }
    .business_type13 .business_info .backImg:nth-child(5){background:url('images/E-Mark_mercedes3.jpg') no-repeat center top; }
    .business_type13 .business_info .backImg:nth-child(6){background:url('images/E-Mark_mercedes4.jpg') no-repeat center top; }
    .business_type13 .business_info .backImg:nth-child(7){background:url('images/E-Mark_mercedes5.jpg') no-repeat center top; }
    .business_type13 .business_info .backImg:nth-child(8){background:url('images/igcert_powerfulBusiness.jpg') no-repeat center top; }
...
<!--			<li><a href="javascript:;">E-MARK</a></li>-->
		</ul>
	</div>
	<!--+++ /20.05.07 탭메뉴 +++-->
...
<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:50px;margin-top:2px;width:100%;">
	...
	<div class="tab_con">
		...
		<article><!--+++++ 컨텐츠 01 (처음 활성화 컨텐츠에만 style="display:block") +++++-->	
	       <div class="page_title">
	       	<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE | MDD 의료기기</span> / 유럽 제품인증 소개</h1>
	       	<h2 class="sub_txt">
	       ...
	       <div class="business_type3">
	       	<div class="business_info">
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">적용 품목</p>
	       				<ul>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">적격성 평가 절차</p>
	       				<ul>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">MDD 종료 시점</p>
	       				<ul>
	       					...
	       					<li>유럽의 Competent Authority에서 공식적으로 발행한 상기의 자료를 확인해 보실 수 있습니다.</li>
	       				</ul>
	       				<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:2px;margin-top:50px;width:100%;">
	       				                                    &#10057; &#10057; &#10057;
	       				<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:50px;margin-top:2px;width:100%;">
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">CE / MDD 제공 서비스</p>
	       				<ul>
	       					<li>IGC는 현재 3개의 Notified Body(이하 NB)기관과 협력하여 CE/MDD 프로젝트를 진행하고 있습니다. </li>
	       					<li>이로 인해, Class l 부터 Class lll까지 거의 모든 스콥에 관하여 예외 없이 신청을 진행할 수 있습니다. </li>
      ...
      <article>      <!--+++++ /컨텐츠 02 CE MDR 컨텐츠 시작 +++++-->
           <div class="page_title">
		     <h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE MDR | 의료기기 </span> / 유럽 제품인증 소개</h1>
		     <h2 class="sub_txt">
	        			...
	        			<div class="txt_area">
	        				...
	        				<ul>
                                 <span style="display:block;text-align:left;font-weight:200;">
                                    ...
                                    21.	 PSUR(Periodic Safety Update Report) 정기적으로 update : IIa, IIb, III 제품 Article 86<br>
       ...
       </article><!--+++++ /컨텐츠 02 CE MDR 컨텐츠 종료 +++++-->
 
       <article>       <!--+++++ /컨텐츠 03 임상평가 컨텐츠 시작 +++++-->
          <div class="page_title">
	       	<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">임상평가</span> / 유럽 제품인증 소개</h1>
	       	<h2 class="sub_txt">
                   <span style="margin:0 auto;display:inline-block;text-align:justify;">임상평가는 의료기기와 관련된 임상 데이터를 수집하고 평가하여 안전성, 효과 및 성능을 검증하고 관련 규제 요건에 대한 적합성을 입증하는 과정입니다.<br>
	       ...
	       <div class="business_type5">
	       	...
	       	<!----// 1st ----->
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">MDR과 임상</p>
	       				<ul>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">임상평가 수행 단계</p>
	       				<ul>
                                <span style="display:block;text-align:left;font-weight:300;">
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">임상시험 자료 필수 사항</p>
	       				<ul>
	       					<li>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">PMS란?</p>
	       				<ul>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">PMS 보고서 작성</p>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				...
	       				<ul>
	       					...
	       					<li style="display:block;text-align:justify;font-weight:300;">Class IIb, Class III 등급의 의료기기를 제조하는 업체는 매년 PSUR을 제출해야 하며, Class IIa 등급의 의료기기를 제조하는 업체는 최소 2년에 한번 PSUR을 제출해야 합니다.</li>
	       		...
	       		<div class="backImg">
	       			<div class="txt_area">
	       				<p class="tit" style="text-align:left;">IGC인증원의 역량</p>
	       				<ul>
       ...
       </article><!--+++++ /컨텐츠 03 임상시험 종료 +++++-->

       <article><!--+++++ /컨텐츠 04 CE IVD/IVDR 컨텐츠 시작 +++++-->
           	<div class="page_title">
		      <h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE IVD/IVDR | 체외진단용 의료기기 </span> / 유럽 제품인증 소개</h1>
		      <h2 class="sub_txt">
	...
	<div class="business_type6">
		<div class="business_info">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">체외진단의료기기의 이해</p>
					<ul>
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">IVD/IVDR 주요 변경 사항</p>
					<ul>
                        <li style="margin:0 auto;text-align:justify;">	
    ...
    <article style="display:block;">    <!--+++++ /컨텐츠 05 CE LVD/EMC(유럽 저전압기기 지침) 컨텐츠 시작 +++++-->
         <div class="page_title">
		    <h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE LVD/EMC | 저전압기기/전자파적합성 </span> 유럽 제품인증 소개</h1>
		    <h2 class="sub_txt">
            <span style="margin:0 auto;display:inline-block;text-align:justify;">
            <p class="tit" style="font-size:1.3em;text-align:left;font-weight:500;">CE LVD/EMC란?</p>
            ...
            <br><br>
              ...
              <br>
              <p class="tit" style="font-size:1.4em;text-align:left;font-weight:500;">적용 가능한 위해요소(Hazard)</p><br>
		  ...
		  <hr style="border-top: 1px dotted #999999;display:block;margin-bottom:50px;margin-top:2px;width:100%;">
		  <p class="tit" style="font-size:1.4em;text-align:left;font-weight:500;">CE LVD / EMC 인증절차</p><br>
		  <span style="font-weight:bold;">&#8280; LVD 인증범위</span>
          <p>2014/35/EU에 따르면 AC50~1000V 또는 DC75~1500V의 정격전압을 가진 전기제품에 적용합니다. (단, Annex II에 열거된 제품은 제외(방폭기기, 방사선 및 의료기기, 승강기의 전기부품, 전기계량기, 옥내용 플러그 및 소켓 outlet, 전기 철조망 제어기, 전파 방해 기기, 국제기구에서 작성한 안전규정에 부합한 선박,항공기,철도에 사용되는 특수전기기기))</p><br><br>
		...
		<div class="business_info">		
			<div class="backImg" style="width:100%;/*본문 좌우 폭*/ margin-top:0; float:none; margin-left:10px; padding-top:750px;">
				<div class="txt_area">
					<p class="tit" style="font-size:1.4em;text-align:left;font-weight:500;">상세 절차</p>
					<ul>
						<li style="margin:0 auto;text-align:justify;">
						<span style="font-weight:bold;">[제1단계]</span><br>
                          ...
                          4.	제품에 적용할 지침이 결정되었다면 해당지침별로 시험할 유럽 시험규격들을 결정해야 한다.<br>
						</li> <br>
						<li style="margin:0 auto;text-align:justify;"> 
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="font-size:1.4em;text-align:left;font-weight:500;">CE LVD/EMC 인증의 사후관리</p>
					<ul>
	...
	<section class="partner_type2">
		...
		<div class="con_box">
			<ul>
			IGC는 다음과 같은 인증 및 관련 서비스를 제공하고 있습니다.<br>
				<li><p><em><strong>01</strong></em><span>경영시스템 인증</span></p></li>
				<li><p><em><strong>02</strong></em><span>제품인증 서비스</span></p></li>
				<li><p><em><strong>03</strong></em><span>제품 시험</span></p></li>
 ...
 </article><!--+++++ /컨텐츠 05 CE LVD/EMC 컨텐츠 종료 +++++-->

<article><!--+++++ /컨텐츠 06번째 CE Machinery 컨텐츠/business_type8 시작 +++++-->
	<div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE Machinery | 기계류 </span> / 유럽 제품인증 소개 </h1>
		<h2 class="sub_txt">
            <span style="margin:0 auto;display:inline-block;text-align:justify;">
	...
	<div class="business_type8">
		<div class="business_info">
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">CE Machinery(기계류 안전) 유럽 제품인증 개요</p>
					<ul>
						<li style="margin:0 auto;text-align:justify;">
			...
			<div class="backImg">
				<div class="txt_area">
                    ...
                    <ul>
					    <span style="display:block;text-align:left;font-weight:bold;"> &#10048; CE Machinery Directive(2006/42/EC) 핵심 요구사항 </span>
					    <br>
					    <span style="display:block;text-align:left;font-weight:300;">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">관련 문서</p>
					<ul>
					<span style="display:block;text-align:left;font-weight:300;">
...
</article><!--+++++ /컨텐츠 06번째 CE Machinery 컨텐츠/business_type8 종료 +++++-->
       
<article><!--+++++ /컨텐츠 07번째  PED 컨텐츠 시작 +++++-->
	<div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE PED | 압력장비 </span> / 유럽 제품인증 소개 </h1>
		<h2 class="sub_txt">
            <span style="margin:0 auto;display:inline-block;text-align:justify;">
	...
	<div class="business_type9">
		<div class="business_info">
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">인증범위</p>
					<ul>
						<li style="margin:0 auto;text-align:justify;">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">압력 기기의 입증 (CE marking)</p>
					<ul>
						<li style="margin:0 auto;text-align:justify;">
	...
	<section class="partner_type2">
		...
		<div class="con_box">
			<ul>
				<li><p><em><strong>01</strong></em><span>경영시스템 인증</span></p></li>
				<li><p><em><strong>02</strong></em><span>제품 인증 서비스</span></p></li>
				<li><p><em><strong>03</strong></em><span>제품 시험</span></p></li>
				<li><p><em><strong>04</strong></em><span>심사자격 인증 서비스</span></p></li>
				<li><p><em><strong>05</strong></em><span>심사원 교육 및 양성</span></p></li>
			</ul>
...
</article><!--+++++ /컨텐츠 06번째 PED 컨텐츠 종료 +++++-->
       
<article><!--+++++ /컨텐츠 08번째 SPVD 시작 +++++-->
	<div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">CE SPVD | 단순압력용기 </span>유럽 제품인증 소개
        </h1>
		<h2 class="sub_txt">
            <span style="margin:0 auto;display:inline-block;text-align:justify;">
	...
	<div class="business_type10">
		<div class="business_info">
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">적용품목/적용 제외 품목</p>
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">필수 요건</p>
					<ul style="display:block;text-align:left;">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">SPVD의 중요성</p>
					<ul style="display:block;text-align:left;">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">적합성 평가 절차</p>
					<ul style="display:block;text-align:left;">
...
</article><!--+++++ /컨텐츠 08번째 SPVD 컨텐츠 종료 +++++-->
 
<article><!--+++++ /컨텐츠 09번째, Hot-water boiler, 컨텐츠 시작 +++++-->

    <div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">Hot-water boiler </span> / 유럽 제품인증 소개</h1>
		<h2 class="sub_txt">
            <span style="margin:0 auto;display:inline-block;text-align:justify;">
	...
	<div class="business_type11">
		<div class="business_info">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">적용 제외 품목</p>
					<ul style="display:block;text-align:justify;">
			...
			<div class="backImg">
				<div class="txt_area">
					<p class="tit" style="text-align:left;">효율성 요구사항</p>
					<ul style="display:block;text-align:justify;">
...
</article><!--+++++ /컨텐츠 09번째, Hot-water boiler, 컨텐츠 종료 +++++-->
       
<article><!--+++++ /컨텐츠 10번째 Gas Applicance 컨텐츠 시작 +++++-->
    <div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">Gas Appliance | 가스 연료 연소기기 </span> <br> 유럽 제품인증 소개</h1>
		<h2 class="sub_txt">
  ...
  </article><!--+++++ /컨텐츠 10번째 Gas Applicance 컨텐츠 종료 +++++-->
  
  
  <article><!--+++++ 컨텐츠 11 E-MARK (처음 활성화 컨텐츠에만 style="display:block") +++++-->	
  <div class="page_title">
		<h1 class="sub_tit"><span class="fc_pointer" style="color:#ff3333;">E-MARK | 자동차인증 </span> <br> 유럽 제품인증 소개</h1>
		<h2 class="sub_txt">
            ...
            EU 자동차 인증은 ECE(Economic Commission for Europe: 유럽경제위원회) 및 EU(European Union: 유럽연합)의 자동차, 관련부품 및 전장품 등을 포함한 자동차의 포괄적인 적합성 규제입니다.<br>
            유럽연합 시장으로 자동차 및 자동차 부품을 판매하고자 하는 기업은 관리 감독 기관인 EU 회원국의 교통부로부터 EU 자동차 분야의 승인제도인 E-Mark 인증을 받아야 합니다.<br>
            E-Mark 인증을 받은 자동차 또는 자동차 부품만이 유럽연합 내에서 자유롭게 수출 및 거래될 수 있습니다.<br>
		...
		<div class="business_info">
		    ...
		    <div class="backImg">
				<div class="txt_area"><br>
					<p class="tit" style="text-align:left;color:dodgerblue;">적용 품목</p>
					<ul style="display:block;text-align:justify;">
                        일반적으로 자동차, 트럭, 버스, 트레일러 및 기타 도로 주행 차량 (차량 탑재 ESA/부품 포함)은 이제 전자기 호환성에 대한 UNECE 규정 10을 준수해야 합니다. 이에 따라 형식 승인 인증을 받은 시스템 EMC에 대한 UNECE Regulation 10은 대문자 “E” E-Mark로 표시되어 있습니다.
					</ul>
					
					<ul style="display:block;text-align:justify;">
						<span style="font-weight:bold;">e-Mark 적용 품목</span><br>
                        EU지침에 준수하는 차량 및 부품: 스티어링 장치, 브레이크, 각종 램프, 난방 시스템, 속도계, 헬멧, 아동용 안전 의자, 배기관, 도난 방지 장치, 타이어, 안전 벨트, 연결 장치, 자동차용 유리, 냉방 시스템, 저류 보호, 버스의 내장재, 경음기, 시트 및 해드레스트 등. <br><br>
					</ul>
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:2px;margin-top:50px;width:100%;">
					                                    &#10057; &#10057; &#10057;
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:50px;margin-top:2px;width:100%;">
			...
			<div class="backImg">
				<div class="txt_area"><br>
					<p class="tit" style="text-align:left;color:dodgerblue;">적용 규격</p>
					<ul style="display:block;text-align:justify;">
                        UN-ECE Regulation 10 that replaced the ‘Automotive Electromagnetic Compatibility Directive’ 2004/104/EC (AEMCD) in November 2014. / 2014년 11월 '자동차 전자기 호환성 지침 2004/104/EC (AEMCD)를 대체 한 UN-ECE 규정 10
					</ul>
					
					<ul style="display:block;text-align:justify;">
						<span style="font-weight:bold;">e-Mark 관련규격</span><br>
                       2007/46/EC: approval of motor vehicles and their trailers, and of systems, components and separate technical units intended for such vehicles / 자동차 및 트레일러, 그리고 그러한 차량을 위한 시스템, 부품 및 별도의 기술 장치의 승인<br><br>
					</ul>
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:2px;margin-top:50px;width:100%;">
					                                    &#10057; &#10057; &#10057;
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:50px;margin-top:2px;width:100%;">
			...
			<div class="backImg">
				<div class="txt_area"><br>
					<p class="tit" style="text-align:left;color:dodgerblue;">E-Mark 와 e-Mark 차이점</p>
					<ul style="display:block;text-align:justify;">
						<span style="font-weight:bold;">E-Mark</span><br>
                        E-Mark는 EU에 판매되는 승인된 차량 및 차량 부품에 대한 UN마크로, 자동차의 부품이나 시스템의 형식승인에 대한 인증입니다.<br>
                        E-Mark는 세계 기준인 ECE Regulation에 적합하다는 것을 의미합니다.
					</ul>
					
					<ul style="display:block;text-align:justify;">
						<span style="font-weight:bold;">e-Mark</span><br>
                        e-Mark는 EU에 판매되는 승인된 차량 및 차량 부품에 대한 EU마크로, 자동차의 부품 및 시스템은 물론 전 차량에 대한 형식승인을 포함하는 인증입니다.<br>
                        e-Mark는 유럽의 강제 지침인 유럽 자동차 EMC 지침에 적합하다는 것을 의미합니다.
                        <br><br>
					</ul>
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:2px;margin-top:50px;width:100%;">
					                                    &#10057; &#10057; &#10057;
			...
			<div class="backImg">
				<div class="txt_area"><br>
					<p class="tit" style="text-align:left;color:dodgerblue;">인증마크</p>
					<ul style="display:block;text-align:justify;">
						<span style="font-weight:bold;">유럽 경제위원회 (ECE, UN 기관) 인증, E-Mark</span><br><br>
                           
                           <div class="container01"><!---e-mark 인증마크 로고 삽입--->
                        <img src="./images/E-Mark_logo.png" alt="인증마크 이미지-유럽 경제위원회 (ECE, UN 기관) 인증, E-Mark">
                        <span class="e-mark01">E-Mark 인증마크</span>
                        </div>
      
                            &#10070; E-Mark는 유럽 경제위원회에서 발행한 규정입니다.<br>
                            &#10070; E-Mark 로고는 원형 프레임입니다. <br>
                            &#10070; 번호는 승인을 부여한 EU 국가 또는 주 번호입니다. 한 국가 / 주가 승인하면 다른 모든 회원국에 대해 충분한 것으로 간주됩니다.<br>
                            &#10070; 국가 / 주 코드는 다음과 같습니다.<br><br>
                            ...
                            <table cellspacing="0" cellpadding="0">
                              ...
                              <col width="108">
                              <tr>
                                <td width="119">E1—Germany</td>
                                <td width="83">E16—Norway</td>
                                <td width="140">E32—Latvia</td>
                                <td width="108">E46—Ukraine</td>
                              </tr>
                              <tr>
                                <td width="119">E2—France</td>
                                <td width="83">E17—Finland</td>
                                <td width="140">E33—</td>
                                <td width="108">E47—South Africa</td>
                              </tr>
                              <tr>
                                <td width="119">E3—Italy</td>
                                <td width="83">E18—Denmark</td>
                                <td width="140">E34—Bulgaria</td>
                                <td width="108">E48—New Zealand</td>
                              </tr>
                              <tr>
                                <td width="119">E4—Netherlands</td>
                                <td width="83">E19—Romania</td>
                                <td width="140">E35—</td>
                                <td width="108">E49—Cyprus</td>
                              </tr>
                              <tr>
                                <td width="119">E5—Sweden</td>
                                <td width="83">E20—Poland</td>
                                <td width="140">E36—Lithuania</td>
                                <td width="108">E50—Malta</td>
                              </tr>
                              <tr>
                                <td width="119">E6—Belgium</td>
                                <td width="83">E21—Portugal</td>
                                <td width="140">E37—Turkey</td>
                                <td width="108">E51—Korea</td>
                              </tr>
                              <tr>
                                <td width="119">E7—Hungary</td>
                                <td width="83">E22—Russia</td>
                                <td width="140">E38—</td>
                                <td width="108">E52—Malaysia</td>
                              </tr>
                              <tr>
                                <td width="119">E8—Czech Republic</td>
                                <td width="83">E23—Greece</td>
                                <td width="140">E39—Azerbaijan</td>
                                <td width="108">E53—Thailand</td>
                              </tr>
                              <tr>
                                <td width="119">E9—Spain</td>
                                <td width="83">E25—Croatia</td>
                                <td width="140">E40—Macedonia</td>
                                <td width="108">E54—</td>
                              </tr>
                              <tr>
                                <td width="119">E10—Yugoslavia</td>
                                <td width="83">E26—Slovenia</td>
                                <td width="140">E41—</td>
                                <td width="108">E55—</td>
                              </tr>
                              <tr>
                                <td width="119">E11—United Kingdom</td>
                                <td width="83">E27—Slovakia</td>
                                <td width="140">E42—European    Community</td>
                                <td width="108">E56—Montenegro</td>
                              </tr>
                              <tr>
                                <td width="119">E12—Austria</td>
                                <td width="83">E28—Belarus</td>
                                <td width="140">E43—Japan</td>
                                <td width="108">E56—Tunisia</td>
                              </tr>
                              <tr>
                                <td width="119">E13—Luxembourg</td>
                                <td width="83">E29—Estonia</td>
                                <td width="140">E44—</td>
                                <td width="108">　</td>
                              </tr>
                              <tr>
                                <td width="119">E14—Switzerland</td>
                                <td width="83">E31—Bosnia</td>
                                <td width="140">E45—Australia</td>
                                <td width="108">　</td>
                              </tr>
                            </table>
					</ul>
					...
					<ul style="display:block;text-align:justify;">
						<span style="font-weight:bold;">EU 인증 (EC), e-Mark</span><br><br>
                        
                        <div class="container01"><!---e-mark 인증마크 로고 삽입--->
                           <img src="./images/e-Mark_logo2.png" alt="인증마크 이미지-EU 인증 (EC), e-Mark">
                           <span class="e-mark01" style="margin-top:-15%;">e-Mark 인증마크</span>
                        </div>
                        
						    &#10070; e-Mark는 EU 지침을 기반으로한 안전 인증 마크입니다. <br>
						    &#10070; EU 집행위원회는 회원국이 자동차, 부품 및 시스템에 적용하도록 요구합니다. <br>
						    &#10070; e-Mark 로고는 직사각형 프레임입니다. <br>
						    &#10070; 번호는 승인을 부여한 EU국가 또는 주 번호입니다. 한 국가 / 주가 승인하면 다른 모든 회원국에 대해 충분한 것으로 간주됩니다. <br>
						    &#10070; 국가 / 주 코드는 다음과 같습니다.<br><br>
						    ...
						    <table cellspacing="0" cellpadding="0">
                              ...
                              <col width="134">
                              <tr>
                                <td width="113">e1 – Germany</td>
                                <td width="162">e11 – United    Kingdom</td>
                                <td width="134">e24 – Ireland</td>
                              </tr>
                              <tr>
                                <td width="113">e2 – France</td>
                                <td width="162">e12 – Austria</td>
                                <td width="134">e26 – Slovenia</td>
                              </tr>
                              <tr>
                                <td width="113">e3 – Italy</td>
                                <td width="162">e13 –    Luxembourg</td>
                                <td width="134">e27 – Slovakia</td>
                              </tr>
                              <tr>
                                <td width="113">e4 – Netherlands</td>
                                <td width="162">e17 – Finland</td>
                                <td width="134">e29 – Estonia</td>
                              </tr>
                              <tr>
                                <td width="113">e5 – Sweden</td>
                                <td width="162">e18 – Denmark</td>
                                <td width="134">e32 – Latvia</td>
                              </tr>
                              <tr>
                                <td width="113">e6 – Belgium</td>
                                <td width="162">e19 – Romania</td>
                                <td width="134">e34 – Bulgaria</td>
                              </tr>
                              <tr>
                                <td width="113">e7 – Hungary</td>
                                <td width="162">e20 – Poland</td>
                                <td width="134">e36 – Lithuania</td>
                              </tr>
                              <tr>
                                <td width="113">e8 – Czech Republic</td>
                                <td width="162">e21 – Portugal</td>
                                <td width="134">e49 – South    Cyprus</td>
                              </tr>
                              <tr>
                                <td width="113">e9 – Spain</td>
                                <td width="162">e23 – Greece</td>
                                <td width="134">e50 – Malta</td>
                              </tr>
                            </table>
					</ul>
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:2px;margin-top:50px;width:100%;">
	        ...
	        <div class="backImg">
				<div class="txt_area"><br>
					<p class="tit" style="text-align:left;color:dodgerblue;">시험 규격</p>
					<ul style="display:block;text-align:justify;">
                    <!--<span style="font-weight:bold;">E-Mark</span><br>-->
                        Regulation 10 Concerning the approval of vehicles with regard to electromagnetic compatibility<br>
                        규정 10 전자기 호환성과 관련된 차량 승인 관련<br><br>
                         <table cellspacing="0" cellpadding="0">
                           <col width="176">
                           <col width="204">
                           <col width="206">
                           <tr>
                             <td width="176" align="center" bgcolor="#76EFE1"><strong>시험 장비</strong></td>
                             <td width="204" align="center" bgcolor="#76EFE1"><strong>시험항목 </strong></td>
                             <td width="206" align="center" bgcolor="#76EFE1"><strong>시험규격</strong></td>
                           </tr>
                           <tr>
			...
			<div class=backImg>
				<div class="txt_area">
					<p class="tit" style="text-align:left;color:dodgerblue;">인증 절차</p>
					<ul style="display:block;text-align:justify;">
                        1.	신청<br>
                            &nbsp; &nbsp; 신청서 작성 및 제출<br><br>
                        2.	문서&샘플<br>
                        ...
                        3.	시험 실시<br>
                            &nbsp; &nbsp; 샘플 시험 실시<br><br>
                        4.	생산 적합성 검사(Conformity of production)<br>
                            &nbsp; &nbsp; 생산공장의 기술기준에 따라 해당제품을 생산할 능력이 있는지를 평가하는 현장검사 실시.<br>
                            &nbsp; &nbsp; *ISO9000 및 EU 국가 인증 기관에서 발급한 기타 품질 시스템 인증서를 획득 한 제조업체는 공장 검사가 면제될 수도 있습니다.<br><br>
                        5.	시험성적서<br>
                            &nbsp; &nbsp; 시험성적서 발행, 기타 기술문서와 함께 유럽 국가 교통부에 제출<br><br>
                        6.	인증서 발행<br>
                            &nbsp; &nbsp; 서류심사 및 해당 지침에 대한 시험결과와 제조공장에 대한 현장 감사 결과를 종합적으로 검토하여 합격시 유럽 국가 교통부에서 인증서 발행<br><br>
                        7.	정기적 공장심사<br>
                            &nbsp; &nbsp; 발급 기관은 인증된 제품 제조업체의 공장 검사를 정기적 또는 비정기적으로 추적, 검사할 수 있습니다.<br>
                            &nbsp; &nbsp; *ISO9001을 획득한 공장의 경우 공장검사기간이 단축되거나 경우에 따라서는 면제될 수도 있습니다.<br> 
			...
			<div class=backImg>
				<div class="txt_area">
					<p class="tit" style="text-align:left;color:dodgerblue;">준비 사항</p>
					<ul style="display:block;text-align:justify;">
                      제출 문서는 영문으로 작성 및 제출되어야 합니다.<br><br>
                      1. 제조사 관련 정보<br>
                         &nbsp; &nbsp; -제조업체명<br>
                         &nbsp; &nbsp; -제조업체 주소<br> 
                         &nbsp; &nbsp; -사업자등록증 사본<br><br>
                      2. 제품 관련 정보<br>
                         ...
                         &nbsp; &nbsp; -제품사진<br>
                         &nbsp; &nbsp; -회로도<br><br>
                      3. 제조공장의 ISO 9001 또는 IATF 16949 인증서
					</ul>
				    <hr style="border-top: 1px dotted #999999;display:block;margin-bottom:2px;margin-top:50px;width:100%;">
					                                    &#10057; &#10057; &#10057;
					<hr style="border-top: 1px dotted #999999;display:block;margin-bottom:50px;margin-top:2px;width:100%;">
