...
<div class="content_wrap">
	<section class="page_title">
		<h1 class="sub_tit">ISO 31000 <span class="fc_pointer"> 전문인력 양성 교육</span> </h1>
		<h2 class="sub_txt">위험관리 가이드라인 교육과정</h2>
	</section>
	<section class="vision_type5">

	<div class="vision_area">
		<h2 class="title">ISO 31000:2018 개요</h2>
		<ul>
			<li>
				<div class="i_box">
				...
				<div class="con_txt">
					...
					<br><br>
					<span style="text-align:justify;text-justify:inter-word;position:relative;top:10%;">
						이 프레임워크는 조직의 위험 유형과 관계없이 사용할 수 있습니다. 조직이 재무 안정성과 명성을 보호하는 데 도움이 될 것입니다.
					</span>
		...
		<div class="vision_area">
		<h2 class="title">ISO 3100 교육의 중요성</h2>
		<ul>
			<li>
				<div class="i_box">
				...
				<div class="con_txt">
					<span style="text-align:justify;text-justify:inter-word;position:relative;top:10%;">
						위험은 모든 활동에 내재되어 있습니다. ISO 31000은 위험에서 파생되는 공공 및 민간, 기간산업 및 상업을 하는 데 도움이 될 수 있습니다.
					</span>
					<br><br>
					<span style="text-align:justify;text-justify:inter-word;position:relative;top:10%;">
						ISO 31001의 효과적인 적용을 위하여 기업과 산업체는 적격성을 갖춘 전문가를 필요로 합니다. ISO 31001 교육과정의 목적은 이 프로그램을 통해 교육받은 심사원 및 개인이 적격하다는 신뢰성을 인증원과 기업 및 산업 분야에 제공하기 위함입니다.
				    </span>
				    <br><br>
				    <span style="text-align:justify;text-justify:inter-word;position:relative;top:10%;">
						인증 절차의 일환으로 적격성을 규정하는 핵심 기술, 지식 및 경험을 반영하는 요구사항에 따라 평가가 진행될 것입니다. ISO 31001 교육 프로그램은 ISO 31001 규격을 기본으로 하고 있고, 심사 가이던스 규격 ISO 19011:2018에 근간을 두고 있습니다.
				    </span>
				</div>
			</li>
		</ul>
