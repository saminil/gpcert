...
<article>  <!----// 컨텐츠 02 ISO/IEC 27001 Tab Menu  // 20.07.29 탭메뉴 컨텐츠 영역  시작------->
    ...
    <article>  <!----// 컨텐츠 04 ISO/IEC 27005 Tab Menu  // 20.07.29 탭메뉴 컨텐츠 영역  시작------->
    <!--+++++ (처음 활성화 컨텐츠에만 style="display:block") +++++-->
      <section class="page_title">
    ...
    <article style="display:block">  <!----// 컨텐츠 05 ISO/IEC 27032 Tab Menu  // 20.07.29 탭메뉴 컨텐츠 영역  시작------->
    <!--+++++ (처음 활성화 컨텐츠에만 style="display:block") +++++-->
	...
	<section class="vision_type5">
		...
		<ul>
			<li>
				...
				<div class="con_txt">
					<span>
						사이버 공간은 인터넷 상에서 사람, 소프트웨어 및 서비스가 상호작용하는 복잡한 환경으로, 전 세계적으로 분산된 정보통신기술 장치와 연결된 네트워크의 지원을 받고 있습니다. 그러나 사이버 공간에서 조직과 정보 제공자 간의 커뮤니케이션이 부족하고 이들 영역 사이의 격차가 있기 때문에 보안 상의 문제가 발생할 수 있습니다. 국제 표준인 ISO/IEC 27032는 신뢰성, 협력, 정보 교환 및 사이버 공간 내 이해 관계자 간의 시스템 통합을 위한 기술 지침의 수립을 다루는 정책 프레임 워크를 제공합니다.
					</span>
					<br>
					<span>
						ISO/IEC 27032는 정보 보안, 네트워크 및 인터넷 보안, 중요한 정보 인프라 보호 (CIIP)와 관련하여 사이버 공간에서 다양한 보안들의 역할을 강조하기 위한 규격입니다. ISO/IEC 국제 표준은 사이버 공간의 서로 다른 보안 도메인 사이의 격차를 해소하고, 해킹, 사이버 공격, 악성 소프트웨어와 같은 사이버 보안 상의 위험을 해결하기 위한 기술적 지침을 제공합니다.
					</span>
				</div>
			</li>
		</ul>
		...
		<ul>
			<li>
				...
				<div class="con_txt">
					...
					<br>
					<span>
						심사원 과정의 일환으로 당사는 적격성을 정의하는 주요 능력, 지식 그리고 경험을 반영하는 요구사항에 대비하여 평가할 것입니다. 교육 프로그램은 심사 주요 표준에 기초합니다.
					</span>
				</div>
			</li>
		</ul>
	  ...
	  <section class="vision_type5">
		...
		<ul>
			<li>
				...
				<div class="con_txt">
					<span>
						오늘날 비즈니스 세계에서 정보 보안 사고는 비즈니스를 심각하게 손상시킬 수 있는 예기치 않은 위험으로 간주됩니다. 따라서, 조직은 즉시 사건을 식별, 평가 및 효과적으로 관리하기 위한 조치를 취해야 합니다.
					</span>
					<br>
					<span>
					    ISO/IEC 27035-1 정보 보안 사고 관리는 전략적 사고 관리 계획을 수행하고 사고 대응을 준비하기 위한 모범 사례와 지침을 제공하는 국제 표준입니다. 오 정보 보안 사고 관리 기능을 갖춘 조직은 비즈니스 위험을 관리할 수 있습니다.
					</span>
				    <br>
					<span>
						마찬가지로, ISO/IEC 27035-1 프레임 워크는 효과적인 정보 보안 관리, 사고 완화 및 지속 가능한 비즈니스 프로세스 구축 능력을 갖춘 조직의 보안 구조에서 중요한 기능입니다. ISO/IEC 27035-1 정보 보안 사고 관리는 포괄적인 전문 지식을 갖춘 개인이 정보 보안 사고를 탐지, 보고 및 평가할 수 있도록 지원합니다.
					</span>
				</div>
			</li>
		</ul>		
	   ...
	   <section class="vision_type5">
		...
		<ul>
			<li>
				...
				<div class="con_txt">
					<span style="text-align:justify;text-justify: inter-word;">
						ISO 27799는 헬스케어 산업 및 고유한 운영 환경에서 근무하는 모든 개인이 보유한 건강 데이터의 기밀성, 무결성 및 가용성을 최상으로 보호하는 방법에 대한 지침을 제공하는 국제 표준입니다.
					</span>
					<br><br>
					<span style="text-align:justify;text-justify: inter-word;">
		...
		<ul>
			<li>
				...
				<div class="con_txt">
					...
					<span style="text-align:justify;text-justify:inter-word;position:relative;top:10%;">
						이는 일반적인 개인 정보 용어를 지정하고, PII 처리에 있어 행위자와 그 역할을 정의하며, 친숙한 개인 정보 원칙을 참조하여 실행할 수 있습니다.
					</span>
					<span style="text-align:justify;text-justify:inter-word;position:relative;top:10%;">
