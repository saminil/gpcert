...
<div class="content_wrap">
	...
	<section class="partner_type2">
		...
		<p style="text-align:justify;text-justify: inter-word;font-family:georgia;">
            직원이 기업의 최고 자산입니다. 직원들이 최신 경영 동향, 관련 규격, 품질 및 안전에 관한 요구 사항 등에 정통하다면 기업 또한 그렇습니다. 그렇기 때문에 교육에 대한 투자는 기업의 성공을 보장하는 확실한 투자입니다. 직원의 역량을 최대한 개발하기 위해서는 먼저 최선의 교육 파트너를 찾아야 합니다. IGC는 직업 안전, 경영 시스템 및 전문 기술에서부터 최고 경영자를 위한 교육 프로그램에 이르기까지 종합적인 교육 프로그램을 제공하여 기업의 효율성을 향상시키며, 고객 여러분께 유형의 경제적 가치를 제공하고 있습니다. 직원 교육 분야에서 풍부한 경험을 보유한 적임자가 제공하는 IGC의 직원 교육 프로그램은 고객 여러분의 직원들에게 전문성과 경쟁력을 제공할 것입니다. IGC의 교육 프로그램을 통해 직원들의 능력을 개발하고 전문성의 함양하여 기업의 사업 목표를 달성하시기 바랍니다.
		</p>
		</div>
    </section>	
       ...
       <div class="con_area">
			...
			<div class="txtArea">
				...
				<ul>
					...
					<!----li><a href="./igc_049_ISO-IEC17025.php"><span><div  class="arrow test_4"></div>ISO/IEC 17025</span></a></li---><!-----li>
					<span>분야01</span> 00000000 &nbsp;<span>분야02</span> 11111111</li---->
				</ul>
			</div>
		</div>
        ...
        <div class="con_area">
			<div class="thumb">
              <a href="#">
			    <h3>시험 및 교정</h3>
				<img src="../image/partner_img1.jpg" alt="시험 및 교정">
              </a>
			</div>
			<div class="txtArea">
		...
		<div class="con_area">
 		...
 		<div class="con_area">
			...
			<div class="txtArea">
				<p class="tit"><보건 및 안전 - 1라인 우측></p>
				<ul>
					<li><a href="#"><span><div  class=""></div>ISO/IEC 17025</span></a></li>
					<li><a href="#"><span><div  class=""></div></span></a></li>
					<li><a href="#"><span><div  class=""></div></span></a></li>
					<li><a href="#"><span><div  class=""></div></span></a></li>
				</ul>
