...
<div id="mb_login" class="mbskin">
    <div class="mbskin_logo">
        <a href="<?php echo G5_URL ?>"><img src="../theme/gpcert/skin/member/basic/img/logo_login.png" alt="gpcertnet"></a>
    </div>
    ...
    <div class="mbskin_copy">
        <p>Copyright © 2017 Global Personnel Certification All Rights Reserved.</p>
    </div>
</div>
