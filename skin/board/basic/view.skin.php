        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		<span class="sound_only">작성자</span> <strong><?php echo $view['name'] ?><span class="mobile_no"><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?></span></strong><br>
       		 	<span class="sound_only">댓글</span><strong><a href="#bo_vc"> <i class="fa fa-comments" aria-hidden="true" style="color:#888"></i> <?php echo number_format($view['wr_comment']) ?>건</a></strong>
	        ...
	        <ul class="btn_bo_user bo_v_com">
	        	...
	        	<li>
		        	...
		        	<ul class="more_opt is_view_btn"> 
			            ...
			            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" onclick="board_move(this.href); return false;">이동<i class="fa fa-arrows-alt" aria-hidden="true"></i></a></li><?php } ?>
