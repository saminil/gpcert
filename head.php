    ...
    <div class="wrap">
        ...
        <div id="telnum" class="s_mobile_none">
            <p>
                ...
                <a href="tel:+82 2 6749-1185" title="전화상담 하기" style="letter-spacing: -.7px">전&nbsp;&nbsp;&nbsp;&nbsp;화 : +82 &nbsp;&nbsp;2&nbsp;&nbsp; 6749-0710</a>
            </p>
            <p>
                <span class="material-icons" style="color:#8f84c9;">forward_to_inbox</span>&nbsp;
                <a href="mailto: info@gicert.org" title="이메일 보내기" style="letter-spacing: .1px">이메일 : info@gpcert.org</a>
            </p>
        </div>
    </div>
</div>
...
<!--		</div>-->
		...
		<div class="util pc_only">
		    <a href="<? Echo G5_URL ?>/gpc_eng/" class="eng" title="To English/영문사이트"><strong class="e_btn"><span class="material-icons">language</span>ENG</strong></a><!--title="ENGLISH"-->
